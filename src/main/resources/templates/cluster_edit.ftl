            ...
            <div class="panel-body">
                <div class="col-md-6 un-pad-me">
                    <form id="cluster-add-form" action="/cluster/save" method="POST" class="form-vertical " role="form">
                        <input value="${cluster.id}" name="id" hidden="true" >
                        <fieldset>
                            <div class="form-group">
                                <label class="control-label">Cluster Name</label>
                                <input type="text" name="clusterName" value="${cluster.clusterName}" class="form-control" readonly="readonly">
                            </div>

                            <div class="form-group">
                                <label class="control-label">Cluster Zookeeper Hosts</label>
                                <input type="text" name="zookeeperAddress" value="${cluster.zookeeperAddress}" class="form-control" placeholder="zk1:2181,zk2:2181,zk3:2181">
                            </div>

                            <div class="form-group">
                                <label class="control-label">Cluster Znode</label>
                                <input type="text" name="znodeParent" value="${cluster.znodeParent}" class="form-control" placeholder="/hbase">
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="version">HBase Version</label>
                                <input type="text" name="version" value="${cluster.version}" class="form-control" >
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="version">HDFS Root Path</label>
                                <input type="text" name="hdfsRootPath" value="${cluster.hdfsRootPath}" class="form-control" placeholder="hdfs://namenode:8020/hbase">
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="version">Web Console Url</label>
                                <input type="text" name="webConsoleUrl" value="${cluster.webConsoleUrl}" class="form-control" placeholder="http://master:60011/master-status">
                            </div>
