			...
			<div class="panel-body">
				<form id="add-form" class="form-horizontal" role="form" action="/mig/task/add" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input id="targetTable" name="targetTable"  type="text" class="form-control" placeholder="请输入目标表名">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input name="runQueue" type="text" class="form-control" placeholder="root.test" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" rows="2" name="programArguments"></textarea>
					...
					<div style="display:none" id="cycle_div">
						<hr>
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input id="ipt_keepCnt" name="keepCnt" class="form-control" type="number" min="0"/>
							</div>
						</div>
						<div class="form-group">
    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data, function (index, cluster) {
                ...
                $('#sourceCluster').selectpicker('val', '');
                $('#targetCluster').selectpicker('val', '');
