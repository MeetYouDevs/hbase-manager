...
@Entity
@Table(name = "table_stat_task")
public class TableStatTask {
	@Id
	...
	public TableStatTask() {
	}

	public TableStatTask(Integer id, String clusterName, String tableName, String cron, Integer intervalPosition,
	...
	public String toString() {
		return "TableStatTask [id=" + id + ", clusterName=" + clusterName + ", tableName=" + tableName + ", cron="
				+ cron + ", intervalPosition=" + intervalPosition + ", interval=" + interval + ", offsetPosition="
